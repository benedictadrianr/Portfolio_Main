  ...
  return (
    <div className="w-screen h-screen fixed top-0 left-0 bg-gradient-to-b from-[#171D25] to-[#0D1013] -z-50 flex flex-col justify-center items-center gap-4">
      ...
      <img
        src={Ellipse4}
        alt="ellipse4"
        className="absolute w-[1000px] -bottom-[800px] left-[500px] -translate-x-1/2 -translate-y-1/2 -z-40"
      />
      <img
        src={Ellipse5}
        alt="ellipse5"
        className="absolute w-[1000px] top-48 -right-[700px] -translate-x-1/2 -translate-y-1/2 -z-40"
      />
